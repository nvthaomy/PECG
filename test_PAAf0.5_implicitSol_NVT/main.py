...
NMolsDicts = [{'PAA':15,'Na+':90,'Cl-':0,'HOH':0}]
...
StepsEquil = 2000 #10000
StepsProd = 2000 #200000
StepsStride = 10
...
BondParams = {('A','A-'):[3.5, 500*kTkcalmol, 'BondA_A-']}
...
#External Potential
UConst = 1.*kTkcalmol
ExtPot = {"UConst": UConst, "NPeriods": 1, "PlaneAxis": 2, "PlaneLoc": 0., 'AtomTypes':['A']}
